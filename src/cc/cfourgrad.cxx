...
class CFOURGradient : public Task
{
    protected:
        Config config;

    public:
        CFOURGradient(const string& name, Config& config)
        ...
        void writeZMAT()
        {
            ...
            ofs << "CALC=CCSD" << endl;
            ofs << "CONSTANTS=UPTODATE" << endl;
            ofs << "FCGRADNEW=2" << endl;
        ...
        void readIntegrals(ifstream& ifs, CTFTensor<double>& H,
        ...
        void writeDensity(ofstream& ofs, const CTFTensor<double>& D,
                          int offp, int offq, int offr, int offs,
                          bool transpq, bool transrs)
        {
