...
template <typename U>
class LambdaCCSDTQ_3 : public Iterative<U>
{
    protected:
        DIIS<DeexcitationOperator<U,3>> diis;

    public:
        LambdaCCSDTQ_3(const string& name, Config& config)
        ...
        void iterate(const Arena& arena)
        {
            ...
            L4.weight({&D.getDA(), &D.getDI()}, {&D.getDa(), &D.getDi()});
              ...
              GABCI[    "abci"]  = -(1.0/ 12.0)*   T4["efabmnoi"]*   L(3)[  "mnoefc"];
            ...
            GAIJBCD[  "aijbcd"]  = -(1.0/  2.0)* T(2)[    "aemn"]*     L4["mijnbcde"];
              ...
              GIJKL[    "ijkl"]  =  (1.0/  4.0)* T(2)[    "efmk"]*GIJKABL[  "mijefl"];
               ...
               Z(3)[  "ijkabc"] += (1.0/ 2.0)*  WABEJ[    "efam"]*     L4["ijkmebcf"];
               Z(3)[  "ijkabc"] -= (1.0/ 2.0)*  WAMIJ[    "eknm"]*     L4["ijmnabce"];
               Z(3)  ["ijkabc"] +=              WMNEF[    "ijae"]*  GAIBC[    "ekbc"];
               Z(3)[  "ijkabc"] -=              WMNEF[    "mkbc"]*  GIJAK[    "ijam"];
               Z(3)[  "ijkabc"] -=              WAMEF[    "eifa"]*GAIJBCD[  "fjkebc"];
               Z(3)[  "ijkabc"] -=              WMNEJ[    "ijem"]*GAIJBCD[  "emkabc"];
               Z(3)[  "ijkabc"] -=              WMNEJ[    "kmcn"]*GIJKABL[  "ijnabm"];
