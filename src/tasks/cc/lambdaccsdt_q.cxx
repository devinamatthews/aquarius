#include "../../frameworks/cc/lambdaccsdt_q.hpp"
...
template <typename U>
LambdaCCSDT_Q<U>::LambdaCCSDT_Q(const string& name, Config& config)
...
template <typename U>
bool LambdaCCSDT_Q<U>::run(TaskDAG& dag, const Arena& arena)
{
...
template <typename U>
void LambdaCCSDT_Q<U>::iterate(const Arena& arena)
{
