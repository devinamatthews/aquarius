#include "../../frameworks/cc/ccsdtq_1a_density.hpp"
...
template <typename U>
CCSDTQ_1a_Density<U>::CCSDTQ_1a_Density(const string& name, Config& config)
: Task(name, config)
{
    vector<Requirement> reqs;
    reqs.push_back(Requirement("moints", "H"));
    reqs.push_back(Requirement("ccsdtq-1a.T", "T"));
    reqs.push_back(Requirement("ccsdtq-1a.L", "L"));
    this->addProduct(Product("ccsdtq-1a.D", "D", reqs));
}

template <typename U>
bool CCSDTQ_1a_Density<U>::run(TaskDAG& dag, const Arena& arena)
{
...
INSTANTIATE_SPECIALIZATIONS(aquarius::cc::CCSDTQ_1a_Density);
REGISTER_TASK(aquarius::cc::CCSDTQ_1a_Density<double>,"ccsdtq-1a_density","");
