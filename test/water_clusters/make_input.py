...
if ( len(sys.argv) != 3 ):
        print "Usage: ./make_nwinput.py <cluster> <basis>"
...
def print_w8d2d(file):
        ...
        file.write('\tatom H       2.10464162     2.10464162    -1.68605609\n')
        file.write('\tatom H      -2.10464162    -2.10464162    -1.68605609\n')
        file.write('\tatom H      -1.52398844     1.52398844      .35383543\n')
        file.write('\tatom H       1.52398844    -1.52398844      .35383543\n')
        file.write('\tatom H       1.52398844     1.52398844     -.35383543\n')
        file.write('\tatom H      -1.52398844    -1.52398844     -.35383543\n')
        file.write('\tatom H       1.51043211      .42340972     1.51629003\n')
        file.write('\tatom H      -1.51043211     -.42340972     1.51629003\n')
        file.write('\tatom H        .42340972    -1.51043211    -1.51629003\n')
        file.write('\tatom H       -.42340972     1.51043211    -1.51629003\n')
        file.write('\tatom H      -1.51043211      .42340972    -1.51629003\n')
        file.write('\tatom H       1.51043211     -.42340972    -1.51629003\n')
        file.write('\tatom H       -.42340972    -1.51043211     1.51629003\n')
...
def print_cholesky(file):
    file.write('cholesky\n')
    file.write('\tdelta 1e-14\n')
    file.write('\tcond_max 1e99\n\n')


cluster    = str(sys.argv[1])
basis      = str(sys.argv[2])
name       = cluster+'_'+basis
filename   = name+'.aq'
